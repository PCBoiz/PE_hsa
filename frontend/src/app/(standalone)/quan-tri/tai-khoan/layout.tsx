...
/**
 * Cổng riêng của trang "tài khoản và vai trò".
 *
 ...
 * Trang này thì KHÔNG: API nó gọi dùng IsAdminRole — đổi vai trò và đặt lại mật khẩu KHÔNG mở cho học vụ (anh Sơn chốt 01/09/2026).
 *
