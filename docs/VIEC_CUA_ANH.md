...
| **Z1** | **Zoom tự gắn bản ghi** (anh đã chọn làm) — nhờ người quản trị tài khoản Zoom của TopHSA tạo ứng dụng **Server-to-Server OAuth**, bật sự kiện **recording.completed**, gửi anh bốn giá trị (Account ID, Client ID, Client Secret, Secret Token); anh dán vào Render → Environment. Tôi viết hướng dẫn từng bấm khi anh bắt đầu. | Đóng dòng 22 và 29 của bảng khách: bản ghi tự vào đúng buổi, trợ giảng khỏi dán link, học viên xem được. | 15 phút |
