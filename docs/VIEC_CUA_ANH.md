...
| **K3** | **Tick ô `G24`** trong bảng phân rã tính năng (dòng STT 22 — quản lý record Zoom). Tôi không tự tick được: Google chặn đăng nhập trong trình duyệt do công cụ điều khiển, connector Drive chỉ sửa được tiêu đề tệp chứ không ghi ô, và Chrome/Edge bản 153 chặn gỡ lỗi từ xa trên profile mặc định. | Dòng 22 đã chạy đủ cả tám gạch đầu dòng — đã đo trên màn thật và soi ảnh 26/09. | 10 giây |
